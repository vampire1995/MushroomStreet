...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-10-20 09:56:27
-- 服务器版本： 5.6.25
-- PHP Version: 5.6.11
...
INSERT INTO `feiniu` (`sid`, `title`, `price`, `url`) VALUES
...
--
-- AUTO_INCREMENT for table `feiniu`
--
ALTER TABLE `feiniu`
  MODIFY `sid` tinyint(2) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=51;
